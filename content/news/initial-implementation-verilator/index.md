...
However, an important initial milestone has already been reached, as visible in the [initial PR](https://github.com/verilator/verilator/pull/7193) that will serve as a starting point for further development. This article explains the rationale behind adding four-state logic in Verilator and describe the current status of the implementation.    
