...
**CHIPS will look a bit different in 2026**. [Rob Mains](https://www.linkedin.com/in/rob-mains-5732972a/) will be retiring and the board has decided to embrace a Community-Driven Leadership Model to ensure long-term financial health and operational efficiency.
...
- **2026 Leadership:** We are pleased to announce [Matt Cockrell](https://www.linkedin.com/in/matthew-cockrell-55000558/) as the 2026 [Governing Board](https://www.chipsalliance.org/about/governance/) Chair and [Aaron Cunningham](https://www.linkedin.com/in/aaroncunningham/) continuing as TAC Chair.   
...
- **SystemVerilog (SV) Tools:** Reflecting the ongoing work within our SystemVerilog Tools Working Group, we’re bringing impactful projects like [Verible](https://github.com/chipsalliance/verible), [RISCV-DV](https://github.com/chipsalliance/riscv-dv), [SV-Tests](https://github.com/chipsalliance/sv-tests) and [Synlig](https://github.com/chipsalliance/synlig) together under a single umbrella to better support project maintainers with TAC representation, marketing, and legal resources.   
- **F4PGA:** Likewise, the [F4PGA](https://f4pga.org/) Working Group has  been working on  breaking down barriers for FPGA hardware developers. We’re bringing these efforts together to join the TAC as we work to amplify their impact through increased marketing and awareness.   
...
- **[OCP EMEA Summit](https://www.opencompute.org/summit/emea-summit):** April 29–30, Barcelona (CFP open until Feb 9). We’ll be hosting a booth and presenting several talks.   
- **[Latch-up 2026](https://fossi-foundation.org/latch-up/2026):** May 1–3, Ontario, Canada.   
- **[DAC 2026](https://dac.com/2026):** July 26–29, Long Beach, CA. We have proposed an Engineering Track session focused on "The Evolution of Collaborative Open Source Hardware Development", and will be sponsoring the Open-Source EDA Birds-of-a-Feather Session. 

#### Get Involved  
The strength of CHIPS Alliance lies in its members. Whether you are interested in shaping the future of secure silicon via [Caliptra](https://github.com/chipsalliance/Caliptra/blob/main/README.md), improving open PDKs, or defining the next generation of AI-driven chip design - now is the time to engage.
- **Join the TAC:** Our [Technical Advisory Council meetings](https://zoom-lfx.platform.linuxfoundation.org/meetings/chips) are open to the public.
- **Connect on Slack:** [Join our Slack workspace](https://slack.chipsalliance.org/) to collaborate with the community, ask questions, and stay up to date on project developments.
- **Contribute:** Explore our [projects](https://www.chipsalliance.org/projects/) and get involved via [GitHub](https://github.com/chipsalliance).
